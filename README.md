...
![](./img/综合应用-1.png)
![](./img/综合应用-2.png)
将 8880 端口的 api/\*接口访问代理到了 3000 端口  
![](./img/综合应用-3.png)
![](./img/综合应用-4.png)
...
fetch 函数：
fetch API 是用来替换 XMLHttpRequest 对象的

封装度比 XMLHttpRequest 要高，fetch 就像封装好的\$.ajax()。当你不想引 jquery/zepto，但又不想自己封装 XMLHttpRequest 时，就用它咯
...
- 代理模式： 打折商品信息的处理 【虽然使用没有严丝合缝代理模式的概念，但是如何使用具体看场景】
